...
| 评测集 | 检索方式 | Recall@8 | MRR | Primary@1 |
| --- | --- | ---: | ---: | ---: |
| 全量种子题 | Token Hybrid | 70.97% | 0.5393 | 45.16% |
| 全量种子题 | Embedding Hybrid | 93.55% | 0.8306 | 74.19% |
| 社区真实候选题 | Token Hybrid | 83.33% | 0.7917 | 50.00% |
| 社区真实候选题 | Embedding Hybrid | 91.67% | 0.8125 | 75.00% |
